...
public class AppConstants {
    ...
    public static final String DATABASE_REFERENCE_USERS_POSTS_FAVORITES = "users_posts_favorites";
    public static final String DATABASE_REFERENCE_USERS_POSTS_LIKES     = "users_posts_thumbsUp";
    public static final String DATABASE_REFERENCE_USERS_POSTS_DISLIKES  = "users_posts_thumbsDown";
    ...
    public static final String POST_INTERACTION_FAVORITES               = "post_interaction_favorites";
    public static final String POST_INTERACTION_LIKES                   = "post_interaction_likes";
    public static final String POST_INTERACTION_DISLIKES                = "post_interaction_dislikes";
    public static final String POST_INTERACTION_COMMENTS                = "post_interaction_comments";
}
